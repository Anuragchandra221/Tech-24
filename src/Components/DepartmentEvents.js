...
function DepartmentEvents() {
  return (
    <div id="department_events" className='pt-5 pb-5 mt-5'>
        ...
        <div className='d-flex justify-content-around flex-wrap px-3 px-lg-4 mt-5 mb-4' style={{rowGap:'15px', color: 'var(--secondary'}}>
        ...
        <div className='d-flex justify-content-center mt-4 p-0 px-lg-3 flex-wrap mt-4'>
