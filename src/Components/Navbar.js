...
function Navbar() {
  ...
  return (
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top py-4 navbar-light " style={{opacity:isBlurred? "1":"1"}}>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            <ul class="navbar-nav mt-2 mt-lg-0">
                ...
                <li class={`nav-item mx-3 d-flex align-items-center ${active=="contact"?'active':''}`}>
