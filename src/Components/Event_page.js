  ...
  return (
    <div className='event-page-overlay'>
      <div className='event-page-content d-flex justify-content-start'>
        <img src={props.src} alt="Event" className='mr-lg-2' />
        <div className='d-flex flex-column justify-content-between ml-lg-2'>
            <div className='pt-4'>
            ...
            <div className='ml-auto d-flex'>
                <button onClick={props.onClose} className='close_btn d-flex justify-content-center align-items-center mr-3 px-3 py-2'>Close</button>
